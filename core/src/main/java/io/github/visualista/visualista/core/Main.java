...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        otherScene.getGrid().getAt(new Point(0,0)).setActor(actor);
        otherScene.getGrid().getAt(new Point(1,1)).setActor(actor);
        otherScene.getGrid().getAt(new Point(1,0)).setActor(actor);
